...
public final class JsonUtils {
    ...
    public static String map2String(Map<?, ?> map) {
        ...
        try {
            ...
            logger.error("将MAP[{}]转换为JSON字符串时发生异常", e);
        }
    ...
    public static String object2String(Object object) {
        try {
            ...
            logger.error(String.format("将对象%s转换为JSON字符串时发生异常", object.getClass()), e);
            return null;
        }
    }
    ...
    public static <T> T[] string2Array(String content, Class<T> clz) {
        ...
        try {
            ...
            logger.error("将字符串[{}]转换为数组时出现异常", e);
            return null;
        }
    }
    ...
    public static <C extends Collection<E>, E> C string2Collection(
        ...
        try {
            ...
            logger.error("将字符串[{}]转换为集合[{}]时出现异常", e);
            return null;
        }
    }
    ...
    public static Map<String, Object> string2Map(String content) {
        ...
        try {
            ...
            logger.error("将字符串[{}]转换为Map时出现异常", e);
            return null;
        }
    }
    ...
    public static <T> T string2Object(String content, Class<T> clz) {
        ...
        try {
            ...
            logger.error(String.format("将字符串%s转换为对象%s时出现异常", content, clz.getName()), e);
            return null;
        }
    }
